    ...
    public function update(Request $request)
    {
        if($request->method() == 'POST')
        {
            $request->validate([
                ...
                '_language.required'=> 'Silahkan Masukan Bahasa Pemograman Yang Kamu Kuasai',
                '_workflow.required'=>'Silahkan Masukan Workflow Yang Kamu Kuasain'
            ]);
            ...
            return redirect()->route('skill.index')->with('success', 'Berhasail Melakukan Update Data Skil');
        }
    }
}
