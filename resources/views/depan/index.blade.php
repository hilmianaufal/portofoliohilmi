    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                <span class="d-block d-lg-none">{{ $about->judul }}r</span>
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div class="subheading mb-5">
                        {{ get_meta_value('_kota') }} . {{ get_meta_value('_provinsi') }} . {{ get_meta_value('_nohp') }} . <a href="mailto:name@email.com">{{ get_meta_value('_email') }}</a> 

                    </div>
                    <div class="div">{!! $about->isi !!}</div>
                    <div class="social-icons">
                        ...
                        <a class="social-icon" href="{{ get_meta_value('_twiter') }}"><i class="fab fa-twitter"></i></a>
